        # Nma Pro V2: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/nma-pro-v2.git

        ## Objective

        NMA Pro v2 is a comprehensive browser-based network meta-analysis tool supporting frequentist and Bayesian frameworks, league tables, and rankograms.
        ...
        - Code: https://github.com/mahmood726-cyber/nma-pro-v2.git
